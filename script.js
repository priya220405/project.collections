async function getWeather() {
    ...
    const apiKey = '023cefd6a30c2bd2c793a3c56f544d4a'; // Replace with a valid API key
    ...
    try {
        ...
        document.getElementById('description').textContent = currentData.weather[0].main;
...
function changeBackground(condition) {
    ...
    console.log(`Applied background: ${body.className}`);
}
